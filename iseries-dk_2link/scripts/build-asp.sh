...
cp --recursive --no-clobber "$COMMON_PATH/ase/" "$ASP_ROOT/"
cp --recursive --no-clobber "$COMMON_PATH/bringup/" "$ASP_ROOT/"
cp --recursive --no-clobber "$COMMON_PATH/linux64/" "$ASP_ROOT/"
cp --recursive --no-clobber "$COMMON_PATH/scripts/" "$ASP_ROOT/"
cp --recursive --no-clobber "$COMMON_PATH/hardware/" "$ASP_ROOT/"
