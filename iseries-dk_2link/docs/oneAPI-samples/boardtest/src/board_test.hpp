...
int ShimMetrics::USMBWTest(sycl::queue &q) {
  ...
  return run_test(q, READ) | run_test(q, WRITE) | run_test(q, MEMCOPY);
  //return run_test(q, MEMCOPY);
  //return run_test(q, MEMCOPY, L1) | run_test(q, READ, L1) | run_test(q, WRITE, L1) | run_test(q, MEMCOPY, L2) | run_test(q, READ, L2) | run_test(q, WRITE, L2) | run_test(q, MEMCOPY, L1L2) | run_test(q, READ, L1L2) | run_test(q, WRITE, L1L2);
}
